...
from read_data_313 import *
from read_data_167_1017E import *
datasets = [
            read_167(),
            ...
            #read_irati_major(log=False),
            #read_irati_major(log=False, trace=True),
            #read_irati_major(log=True),
           ]
...
for run in range(run0, n_runs):
    ...
    for dataset in datasets:#[:1]:
        ...
        for tk, tn in enumerate(dataset['target_names']):
            ...
            ub_ann = [0,    0, 1., 4,        3,  1.0, 1e+0,    1,   2,100,100,100,100] #+ [1.0]*n_features
            #------------------------------------------------------------------                 
