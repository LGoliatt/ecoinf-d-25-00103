...
if __name__ == '__main__':
    ...
    PlotModel(model, filename='model_house_model', view=True)#.plot()
    #%%
...
#        'normalize'      : (False,),
#        'l2'             : (0.01, 0.1, 0.2, 0.5, 0.9, 1.0),
#        'seq_type'       : ('random',),
#        }
#    
#    base_estimator = GMDH()#**params)
#    
#    #sh = GridSearchCV(base_estimator, param_grid, cv=5, verbose=1).fit(X, y)
